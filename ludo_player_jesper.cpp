...
ludo_player_jesper::ludo_player_jesper():
...
void ludo_player_jesper::say_hi()
{
    std::cout << "Jesper";
}

/*int ludo_player_jesper::make_decision(){
    if(dice_roll == 6){
        for(int i = 0; i < 4; ++i){
...
void ludo_player_jesper::start_turn(positions_and_dice relative){
...
void ludo_player_jesper::post_game_analysis(std::vector<int> relative_pos){
