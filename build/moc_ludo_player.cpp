...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ludo_player_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ludo_player_t qt_meta_stringdata_ludo_player = {
    {
QT_MOC_LITERAL(0, 0, 11), // "ludo_player"
QT_MOC_LITERAL(1, 12, 12), // "select_piece"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 13), // "turn_complete"
QT_MOC_LITERAL(4, 40, 10), // "start_turn"
QT_MOC_LITERAL(5, 51, 18), // "positions_and_dice"
QT_MOC_LITERAL(6, 70, 8), // "relative"
QT_MOC_LITERAL(7, 79, 18), // "post_game_analysis"
QT_MOC_LITERAL(8, 98, 16), // "std::vector<int>"
QT_MOC_LITERAL(9, 115, 12) // "relative_pos"
...
const QMetaObject ludo_player::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ludo_player.data,
      qt_meta_data_ludo_player,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ludo_player::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ludo_player.stringdata0))
